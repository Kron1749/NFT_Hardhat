...
!developmentChains.includes(network.name)
    ...
    : describe("Random NFT unit test", async () => {
          ...
          describe("constructor", async () => {
              it("Should start the values correctle", async () => {
          ...
          describe("Mint nft", async () => {
              it("Should emit the event and create NFT", async () => {
              ...
              it("Set the token uri to low when the price is low", async () => {
                  const highValue = ethers.utils.parseEther("100000000000000000")
